...
variable "region" {
  ...
  type        = string
  default     = "{{cookiecutter.gcp_region_prod}}"
}
...
variable "frontend_image" {
  ...
  type        = string
  default     = "{{cookiecutter.frontend_image_name}}:{{cookiecutter.prod_image_tag}}"
}
...
variable "backend_image" {
  ...
  type        = string
  default     = "{{cookiecutter.backend_image_name}}:{{cookiecutter.prod_image_tag}}"
}
